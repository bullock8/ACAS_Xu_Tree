...
if __name__ == "__main__":
    ...
    theta_range = np.linspace(-np.pi/36, np.pi/36, num_thetas) #np.linspace(-np.pi, np.pi, num_thetas)
    psi_range = np.linspace(-np.pi/36, np.pi/36, num_psis)#np.linspace(-np.pi, np.pi, num_psis)
    ...
    if generate_figure:
        ...
        rho_range = np.linspace(0, 60760, num_rhos) # 60760/2
